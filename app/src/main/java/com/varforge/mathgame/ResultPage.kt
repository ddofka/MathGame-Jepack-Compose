...
fun ResultPage(navController : NavController, score : Int){
    ...
    Column(
        modifier = Modifier
            .fillMaxSize()
            .paint(painter = painterResource(R.drawable.third), contentScale = ContentScale.Crop),
        ...
        Row(
            ...
            Button(
                ...
                border = BorderStroke(2.dp, color = colorResource(R.color.blue))
            )
            {
                Text(text = "Play Again", fontSize = 20.sp, color = colorResource(R.color.blue))
            }
            ...
            {
                Text(text = "Exit", fontSize = 20.sp, color = colorResource(R.color.blue))
            }
